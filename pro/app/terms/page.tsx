...
export const metadata: Metadata = { title: 'Terms and Conditions – Zilpo Professional' }
...
const sections = [
  ...
  },
  {
    ...
    body: 'You are required to upload a government-issued ID (Aadhaar Card, PAN Card, Voter ID, or Ration Card) during signup. This document is stored securely and privately. It will only be shared with law enforcement authorities if legally required (e.g. a verified police inquiry or court order). You can request access to your stored document at any time by emailing team@thezilpo.com.',
  },
  {
  ...
  return (
    <main className="min-h-dvh bg-white max-w-[430px] mx-auto px-5 py-6">
      ...
      <div className="mb-6">
        ...
        <h1 className="font-bold text-2xl text-gray-900 mb-1">Terms &amp; Conditions</h1>
